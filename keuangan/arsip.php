        ...
        <li class="nav-item">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                      <div class="card-header py-3">
                        ...
                        <!-- <br> -->
                        <!-- <button type="submit" class="btn btn-danger" id="tombol" target="blank" onclick=""></span> Hapus Data Arsip</button> -->
                      </div>
                      <div class="card-body">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <form role="form" id="form-detail" method="post">
                    <div class="modal-header">
                      <h4 class="modal-title">Detail Data Arsip</h4>
          ...
          <script>
            ...
            tombol.addEventListener('click',function(){
              ...
              .then((result) => {
                if (result.value) {
                  window.location='hapus_arsip.php';
                  Swal.fire(
