                ...
                <div class="row text-white">
                  ...
                  <div class="card bg-success ml-3" style="width: 19rem;">
                    <div class="card-body">
                      ...
                      <a href="pemasukan_guest.php"><p class="card-text text-white">Lihat Detail <i class="fas fa-angle-double-right ml-2"></i></p></a>                    
                    </div>
                  </div>
                  ...
                  <div class="card bg-info ml-3" style="width: 19rem;">
                    <div class="card-body">
                      ...
                      <a href="pengeluaran_guest.php"><p class="card-text text-white">Lihat Detail <i class="fas fa-angle-double-right ml-2"></i></p></a>                    
                    </div>
                  </div>
