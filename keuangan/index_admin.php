    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item active">
          ...
          <!-- Nav Item - Tables -->
          <li class="nav-item">
            <a class="nav-link" href="pemasukan_admin.php">
                          ...
                          <div class="row text-white">
                            ...
                            <div class="card bg-success ml-3" style="width: 19rem;">
                              <div class="card-body">
                                ...
                                <a href="pemasukan_admin.php"><p class="card-text text-white">Lihat Detail <i class="fas fa-angle-double-right ml-2"></i></p></a>                    
                              </div>
                            </div>
                            ...
                            <div class="card bg-info ml-3" style="width: 19rem;">
                              <div class="card-body">
                                ...
                                <a href="pengeluaran_admin.php"><p class="card-text text-white">Lihat Detail <i class="fas fa-angle-double-right ml-2"></i></p></a>                    
                              </div>
                            </div>
