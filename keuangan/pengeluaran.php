...
// tambah data
  function tambah($data)
  {
    ...
    echo "<script>
    window.location='tambah_arsip_pengeluaran.php';
    </script>";
  ...
  if (isset($_POST["ubah"])) {
    ...
    if (ubah_pengeluaran($_POST) > 0 && tambah_arsipp($_POST) > 0) {
      echo "<script>
          ...
          <li class="nav-item ">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                      <div class="card-header py-3">
                        ...
                        <a class="btn btn-info hidden-print" target="blank" href="cetak_pengeluaran.php" onclick=""><span class="fa fa-print"></span> Cetak Laporan</a>
                      </div>
                      <div class="card-body">
            ...
            <div id="add_data_Modal" class="modal fade" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title-bold">Tambah Pengeluaran</h4>
                    <div align="right">
            ...
            <div id="modal_edit" class="modal fade" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title-bold">Edit Pengeluaran</h4>
                    <div align="right">
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                  </div>
            ...
            <script src="js/scriptedit_pengeluaran.js"></script>
