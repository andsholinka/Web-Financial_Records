...
if (isset($_POST["cari"]))
{
  ...
  if ($_POST["waktu"] > 0 && $_POST["waktu2"] > 0) {
    ...
    $query = "SELECT * FROM tb_pemasukan WHERE tgl_masuk between '$waktu' AND '$waktu2'";
      // $query = "SELECT * FROM tb_pemasukan WHERE tgl_masuk LIKE '%" .$waktu.$waktu2. "%'";
  ...
  <div class="card-body">
    <div class="table-responsive">
      ...
      while ($row = mysqli_fetch_array($result))
        ...
        <?php $jumlah=$jumlah+$row['jml_masuk'];  } ?>
        <tr align="center">
